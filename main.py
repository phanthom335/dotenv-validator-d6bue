    """
    Dotenv Validator D6bue
    ======================
    Developer-friendly CLI that helps you archive projects in seconds.
    ...
    APP_NAME    = "Dotenv Validator D6bue"
    APP_VERSION = "1.0.0"
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-friendly CLI that helps you archive projects in seconds.")
